...
export default function HeroSection({ lang }: { lang: Lang }) {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-white dark:bg-neutral-950 pt-16">
      {/* Dot grid background */}
      <div className="absolute inset-0 grid-dot opacity-60 dark:opacity-40" />

      {/* Gradient blobs */}
      <div className="absolute top-24 right-0 w-[600px] h-[600px] bg-orange-500/10 dark:bg-orange-500/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-orange-300/10 dark:bg-orange-700/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/3 pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20 lg:py-32">
        <div className="max-w-4xl">
          ...
          <motion.div {...fadeUp(0.1)} className="flex items-center gap-2 mb-8">
            <span className="flex items-center gap-2 bg-orange-50 dark:bg-orange-950/50 border border-orange-200 dark:border-orange-800/60 text-orange-600 dark:text-orange-400 text-xs font-semibold px-3.5 py-1.5 rounded-full">
          ...
          <motion.div {...fadeUp(0.45)} className="flex flex-wrap gap-4 mb-16 sm:mb-20">
            <a
              href="#work"
              className="group flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-6 py-3.5 rounded-xl transition-all hover:shadow-xl hover:shadow-orange-500/30 active:scale-95 text-sm sm:text-base"
            >
              {t.cta1}
            ...
            <a
              href="#contact"
              className="group flex items-center gap-2 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 text-neutral-800 dark:text-white font-semibold px-6 py-3.5 rounded-xl transition-all hover:border-orange-400 hover:text-orange-500 dark:hover:border-orange-500 dark:hover:text-orange-400 text-sm sm:text-base hover:shadow-md"
            >
          ...
          >
            {[
              ...
              <div key={i} className="group">
                <div className="text-2xl sm:text-3xl font-bold text-neutral-900 dark:text-white mb-0.5 group-hover:text-orange-500 transition-colors">
                  {stat.value}
                </div>
        ...
        <motion.div
          ...
          className="hidden xl:block absolute right-8 top-1/2 -translate-y-1/2 animate-float"
        >
          <div className="w-80 bg-neutral-900 dark:bg-neutral-800 rounded-2xl border border-neutral-700/80 shadow-2xl overflow-hidden">
            {/* Terminal bar */}
      ...
      >
        ...
        <motion.div
          ...
          className="w-4 h-6 border border-neutral-300 dark:border-neutral-600 rounded-full flex items-start justify-center p-1"
        >
